...
export class WidgetValidationService {
  ...
  static getInstance(): WidgetValidationService {
  ...
  validateWidget(config: Partial<WidgetConfig>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  private validateChartWidget(config: Partial<WidgetConfig>, errors: string[]) {
  ...
  private validateMetricWidget(config: Partial<WidgetConfig>, errors: string[]) {
  ...
  private validateTableWidget(config: Partial<WidgetConfig>, errors: string[]) {
    if (!config.settings?.query) {
      errors.push('데이터 쿼리는 필수입니다.');
    }
  ...
  private validateStatusWidget(config: Partial<WidgetConfig>, errors: string[]) {
    if (!config.settings?.query) {
  ...
  validateTheme(theme: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  validateMetricUnit(unit: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
