...
export const fetchServiceConfigs = createAsyncThunk('microservice/fetchServiceConfigs', async () => {
...
export const updateServiceConfig = createAsyncThunk('microservice/updateServiceConfig', async ({ name, config }) => {
...
export const fetchServiceHealth = createAsyncThunk('microservice/fetchServiceHealth', async (name) => {
...
export const fetchServiceMetrics = createAsyncThunk('microservice/fetchServiceMetrics', async (name) => {
...
export const updateCircuitBreaker = createAsyncThunk('microservice/updateCircuitBreaker', async ({ name, config }) => {
