...
export const fetchUserBehaviorPatterns = createAsyncThunk('userBehavior/fetchPatterns', async () => {
...
export const updateUserBehaviorPattern = createAsyncThunk('userBehavior/updatePattern', async (pattern) => {
