...
export const addService = createAsyncThunk('integration/addService', async (service) => {
...
export const updateService = createAsyncThunk('integration/updateService', async ({ id, service }) => {
...
export const addWebhook = createAsyncThunk('integration/addWebhook', async (webhook) => {
