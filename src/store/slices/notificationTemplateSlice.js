...
export const createTemplate = createAsyncThunk('notificationTemplates/createTemplate', async (template) => {
    const response = await fetch('/api/notification-templates', {
        method: 'POST',
        headers: {
...
export const updateTemplate = createAsyncThunk('notificationTemplates/updateTemplate', async (template) => {
...
export const deleteTemplate = createAsyncThunk('notificationTemplates/deleteTemplate', async (templateId) => {
...
export const cloneTemplate = createAsyncThunk('notificationTemplates/cloneTemplate', async (templateId) => {
...
export const importTemplates = createAsyncThunk('notificationTemplates/importTemplates', async (data) => {
...
export const exportTemplates = createAsyncThunk('notificationTemplates/exportTemplates', async () => {
...
export const rollbackTemplate = createAsyncThunk('notificationTemplates/rollbackTemplate', async ({ templateId, versionId }) => {
