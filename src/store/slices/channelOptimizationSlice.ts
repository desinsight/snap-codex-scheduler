...
export const fetchChannelMetrics = createAsyncThunk(
  'channelOptimization/fetchMetrics',
  async () => {
...
export const fetchOptimizationRules = createAsyncThunk(
  'channelOptimization/fetchRules',
  async () => {
...
export const createOptimizationRule = createAsyncThunk(
  'channelOptimization/createRule',
  async (rule: Omit<ChannelOptimizationRule, 'id' | 'createdAt' | 'updatedAt'>) => {
    const response = await fetch('/api/channel-optimization-rules', {
      method: 'POST',
      headers: {
...
export const updateOptimizationRule = createAsyncThunk(
  'channelOptimization/updateRule',
  async (rule: ChannelOptimizationRule) => {
...
export const deleteOptimizationRule = createAsyncThunk(
  'channelOptimization/deleteRule',
  async (ruleId: string) => {
...
export const toggleOptimizationRule = createAsyncThunk(
  'channelOptimization/toggleRule',
  async (ruleId: string) => {
