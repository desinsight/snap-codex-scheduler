...
export const generatePerformanceReport = createAsyncThunk('analysis/generateReport', async (params) => {
...
export const fetchReportById = createAsyncThunk('analysis/fetchReportById', async (reportId) => {
...
export const exportReport = createAsyncThunk('analysis/exportReport', async (reportId) => {
