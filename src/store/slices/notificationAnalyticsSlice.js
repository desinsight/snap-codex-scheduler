...
export const fetchNotificationStats = createAsyncThunk('notificationAnalytics/fetchStats', async () => {
...
export const fetchUserBehaviorPatterns = createAsyncThunk('notificationAnalytics/fetchUserPatterns', async () => {
...
export const fetchFatigueLevels = createAsyncThunk('notificationAnalytics/fetchFatigueLevels', async () => {
...
export const fetchSmartSettings = createAsyncThunk('notificationAnalytics/fetchSmartSettings', async () => {
...
export const updateSmartSettings = createAsyncThunk('notificationAnalytics/updateSmartSettings', async (settings) => {
...
export const adjustNotificationTiming = createAsyncThunk('notificationAnalytics/adjustTiming', async (userId) => {
...
export const updateFatigueSettings = createAsyncThunk('notificationAnalytics/updateFatigueSettings', async (fatigue) => {
