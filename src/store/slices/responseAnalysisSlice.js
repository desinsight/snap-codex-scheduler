...
export const fetchReportById = createAsyncThunk('responseAnalysis/fetchReportById', async (reportId) => {
...
export const generateReport = createAsyncThunk('responseAnalysis/generateReport', async (period) => {
...
export const exportReport = createAsyncThunk('responseAnalysis/exportReport', async (reportId) => {
