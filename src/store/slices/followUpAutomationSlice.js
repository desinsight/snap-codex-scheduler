...
export const createFollowUpRule = createAsyncThunk('followUpAutomation/createRule', async (rule) => {
    const response = await fetch('/api/follow-up-rules', {
        method: 'POST',
        headers: {
...
export const updateFollowUpRule = createAsyncThunk('followUpAutomation/updateRule', async (rule) => {
...
export const deleteFollowUpRule = createAsyncThunk('followUpAutomation/deleteRule', async (ruleId) => {
...
export const toggleFollowUpRule = createAsyncThunk('followUpAutomation/toggleRule', async (ruleId) => {
