...
export const updateSecuritySettings = createAsyncThunk('security/updateSettings', async (settings) => {
    const response = await fetch('/api/security/settings', {
        method: 'PUT',
        headers: {
...
export const updateBackupSettings = createAsyncThunk('security/updateBackup', async (backup) => {
...
export const updateErrorHandling = createAsyncThunk('security/updateErrorHandling', async (errorHandling) => {
