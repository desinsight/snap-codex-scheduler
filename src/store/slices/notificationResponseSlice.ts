...
const initialState: NotificationResponseState = {
  responses: [],
  followUps: [],
  channelTemplates: [],
  channelStatuses: [],
...
export const fetchChannelStatuses = createAsyncThunk(
  'notificationResponse/fetchChannelStatuses',
  async () => {
...
export const fetchChannelSwitchRules = createAsyncThunk(
  'notificationResponse/fetchChannelSwitchRules',
  async () => {
...
export const createChannelTemplate = createAsyncThunk(
  'notificationResponse/createChannelTemplate',
  async (template: Omit<ChannelTemplate, 'id'>) => {
    const response = await fetch('/api/channel-templates', {
      method: 'POST',
      headers: {
...
export const updateChannelTemplate = createAsyncThunk(
  'notificationResponse/updateChannelTemplate',
  async (template: ChannelTemplate) => {
...
export const createChannelSwitchRule = createAsyncThunk(
  'notificationResponse/createChannelSwitchRule',
  async (rule: Omit<ChannelSwitchRule, 'id'>) => {
    const response = await fetch('/api/channel-switch-rules', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export const updateChannelSwitchRule = createAsyncThunk(
  'notificationResponse/updateChannelSwitchRule',
  async (rule: ChannelSwitchRule) => {
...
export const scheduleFollowUp = createAsyncThunk(
  'notificationResponse/scheduleFollowUp',
  async (followUp: Omit<FollowUpNotification, 'id' | 'status' | 'retryCount'>) => {
    const response = await fetch('/api/notification-follow-ups', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
