...
export const updateUserPreferences = createAsyncThunk('preferences/updatePreferences', async (preferences) => {
...
export const submitFeedback = createAsyncThunk('preferences/submitFeedback', async ({ userId, satisfactionScore, feedbackText, }) => {
