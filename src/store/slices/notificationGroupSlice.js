...
export const createGroup = createAsyncThunk('notificationGroups/createGroup', async (group) => {
    // TODO: Replace with actual API call
    const response = await fetch('/api/notification-groups', {
        method: 'POST',
        headers: {
...
export const updateGroup = createAsyncThunk('notificationGroups/updateGroup', async (group) => {
    // TODO: Replace with actual API call
...
export const deleteGroup = createAsyncThunk('notificationGroups/deleteGroup', async (groupId) => {
    // TODO: Replace with actual API call
...
export const toggleGroupActive = createAsyncThunk('notificationGroups/toggleGroupActive', async ({ groupId, isActive }) => {
    // TODO: Replace with actual API call
