...
`;
const CalendarView = ({ events, onEventClick, onDateSelect, onEventDrop, }) => {
    return (_jsx(CalendarContainer, { children: _jsx(StyledCalendar, { plugins: [dayGridPlugin, timeGridPlugin, interactionPlugin], initialView: "dayGridMonth", headerToolbar: {
                left: 'prev,next today',
                center: 'title',
                right: 'dayGridMonth,timeGridWeek,timeGridDay',
            }, editable: true, selectable: true, selectMirror: true, dayMaxEvents: true, weekends: true, events: events, eventClick: onEventClick, select: onDateSelect, eventDrop: onEventDrop, height: "100%" }) }));
};
