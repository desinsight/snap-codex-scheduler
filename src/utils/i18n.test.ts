...
describe('i18n', () => {
  ...
  it('should translate login form texts correctly in Korean', () => {
    ...
    expect(i18n.t('auth.login.email')).toBe('이메일');
    expect(i18n.t('auth.login.password')).toBe('비밀번호');
  ...
  it('should translate login form texts correctly in English', () => {
    ...
    expect(i18n.t('auth.login.email')).toBe('Email');
  ...
  it('should handle loading messages correctly', () => {
    expect(i18n.t('auth.loading.loggingIn')).toBe('로그인 중...');
  ...
  it('should handle error messages correctly', () => {
    expect(i18n.t('auth.login.errors.invalidEmail'))
